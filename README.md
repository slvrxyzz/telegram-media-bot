...
Телеграмм-бот сейчас работает и развернуть на сервере, если есть желание запустить его локально, то вот небольшая инструкция. В таком случае, не забудьте изменить токен бота на токен своего.
